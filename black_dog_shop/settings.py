"""
Django settings for black_dog_shop project.
...
ALLOWED_HOSTS = ['blackdogshop.herokuapp.com', '127.0.0.1']
...
WSGI_APPLICATION = 'black_dog_shop.wsgi.application'
...
if 'USE_AWS' in os.environ:
    # Bucket settings
    AWS_STORAGE_BUCKET_NAME = 'blackdogshop'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'info@blackdogshop.com'
else:
